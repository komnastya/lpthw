import unittest
from deletelarger import delete_large, delete_large_slow, delete_small, delete_large_fast
...
class TestDeleteLarger(unittest.TestCase):
    ...
    def test_delete_large(self):
        ...
        self.assertEqual(delete_large([1,2,3,4,5,6,7,8,9], 9), [1,2,3,4,5,6,7,8,9])
