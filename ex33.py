...
while i < 5: #cycle begins, which will run when i < 5
    ...
    numbers.append(i) # the number from line 7 is put into the list, this is its first element

    i = i + 1 #number + 1

    print ("\nNumbers now: ", numbers) #contents of the array at the current moment is printed
    print (f"\nNext i is {i}") #the number which will be nested next to the array (from line 10)
