...
new_states_dict = dict.fromkeys(keys) #creates a dictionary with keys from 'keys' list and the default value of None
print (new_states_dict)

state_value = 'Unknown abbreviation'
new_states_dict_2 = dict.fromkeys(keys, state_value) #creates a dictionary with keys from 'keys' list and values from state_value for all pairs
print (new_states_dict_2)

value = [1]
dic_a = dict.fromkeys(keys, value) #creates a dictionary with keys from 'keys' list and value [1] for all pairs
print (dic_a)
...
result = states.popitem() #removes the last key + value pair from the dictionary and returns it
...
except_value_2 = states.pop ('Texas', 'TE') #Texas key isn't found, TE value is returned
...
print ('\nWe create Texas key, but its value is not specified, therefore, the value assigned by default is ', g)
print (states)
...
states.update(North_California = 'NC', South_California = 'SC') #'states' dictionary is updated adding two pair (key + value)
print (states)
