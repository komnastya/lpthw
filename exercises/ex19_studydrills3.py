...
def myfriends (name, age):
    ...
    chname = input ()
    print (f"{name} is {age} years old and she has visited {number} countries in 2020. There are {chname}")


myfriends (name, age)
myfriends ('Julia', '27') #the name and age are in the script, function asks only for information about visited countries
