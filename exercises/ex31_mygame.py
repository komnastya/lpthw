...
def door_one ():
   ...
   if bear == "1":
      print ("Поздравляю! Медведь оказался ручным! Теперь вы  вместе пьете пиво, закусывая вторым чизкейком")
      print ("Game over")
   elif bear == "2":
      print ("А Миша говорящий!")
      print ("- Слышь, ты чё тут разорался! Да поделюсь я с тобой, поделюсь, несчастный ты человек")
      print ("Game over")
   elif bear == "3":
...
def start():
   print ("""Привет! Ты попал в мою первую игрушку!
